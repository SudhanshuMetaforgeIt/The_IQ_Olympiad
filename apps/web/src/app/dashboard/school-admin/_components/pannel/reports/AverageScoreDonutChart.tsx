...
interface AverageScoreDonutChartProps {
  categories: DonutCategory[];
}

export const AverageScoreDonutChart: React.FC<AverageScoreDonutChartProps> = ({
  categories,
}) => {
