            ...
            <div>
              <div className="flex items-center justify-between mb-8">
                ...
                <div className="text-purple-600">
                  <svg className="size-6 stroke-[2]" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                ...
                {topPerformers.map((user) => (
                  ...
                  >
                    <div className="flex items-center gap-3.5">
                      <div className="size-8 rounded-full bg-purple-700 text-white font-extrabold text-xs flex items-center justify-center shadow-sm">
                        {user.rank}
                      </div>
                      <div>
