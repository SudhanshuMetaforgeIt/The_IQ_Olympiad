...
import { StudentTotalRecord } from "./types";

interface ResultsAllStudentsTableProps {
  students: StudentTotalRecord[];
}

export function ResultsAllStudentsTable({ students }: ResultsAllStudentsTableProps) {
  return (
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-slate-100 text-xs font-extrabold text-slate-500 uppercase tracking-wider bg-slate-50/60">
              ...
              <th className="py-3.5 px-4 min-w-[150px]">Olympiads Registered</th>
