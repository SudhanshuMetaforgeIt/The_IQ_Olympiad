...
export default function ReportsParticipationRateTrendCard() {
      ...
      <div className="w-full overflow-x-auto">
        <div className="min-w-[620px]">
          <svg viewBox={`0 0 ${width} ${height + 25}`} className="w-full h-60 overflow-visible">
            <defs>
              <linearGradient id="purpleRateFill" x1="0" y1="0" x2="0" y2="1">
            ...
            {/* Gradient Area */}
            <polygon points={areaPoints} fill="url(#purpleRateFill)" />
