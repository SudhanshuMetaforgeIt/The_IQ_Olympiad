...
export default function ReportsTestsConductedTrendCard() {
  const [timeframe, setTimeframe] = useState("Monthly");

  const months = [
    "May '25", "Jun '25", "Jul '25", "Aug '25", "Sep '25", "Oct '25",
    "Nov '25", "Dec '25", "Jan '26", "Feb '26", "Mar '26", "Apr '26", "Apr '26"
  ];

  const dataPoints = [
    { label: "6,205", val: 6.205 },
    { label: "6,842", val: 6.842 },
    { label: "7,125", val: 7.125 },
    { label: "7,832", val: 7.832 },
    { label: "8,104", val: 8.104 },
    { label: "8,965", val: 8.965 },
    { label: "8,230", val: 8.230 },
    { label: "8,745", val: 8.745 },
    { label: "9,210", val: 9.210 },
    { label: "9,856", val: 9.856 },
    { label: "10,214", val: 10.214 },
    { label: "10,214", val: 10.214 },
    { label: "8,965", val: 8.965 },
  ];
      ...
      <div className="w-full overflow-x-auto">
        <div className="min-w-[620px]">
          <svg viewBox={`0 0 ${width} ${height + 25}`} className="w-full h-60 overflow-visible">
            ...
            {/* Gradient Area */}
            <polygon points={areaPoints} fill="url(#purpleFill)" />
