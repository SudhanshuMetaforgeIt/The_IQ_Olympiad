...
function StudentLoginContent() {
  ...
  if (activeRole === "school") {
    return <SchoolAdminLoginPage onSwitchRole={(role) => setActiveRole(role)} />;
  }
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("Login Submitted:", { phone, otp, activeRole });
          ...
          <div>
            ...
            <div className="mb-6">
              ...
              <p className="text-sm font-medium text-slate-500 mt-1">
                Log in as a Student or School Admin.
              </p>
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-bold">
              <p className="text-slate-500">
                New student?{" "}
                <Link href="/signup?role=student" className="text-violet-600 hover:underline font-extrabold">
                  Sign up
                </Link>
              </p>
...
export default function StudentLoginPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-slate-50 flex items-center justify-center font-bold text-slate-500">Loading login...</div>}>
      <StudentLoginContent />
    </Suspense>
  );
}
