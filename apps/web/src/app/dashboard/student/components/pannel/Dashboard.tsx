...
export default function StudentDashboard({ activeTab = "dashboard", onSelectTab }: StudentDashboardProps) {
  ...
  // Render Full Screen Exam Workspace (Step 3: Image 3)
            ...
            <>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 items-stretch">
                ...
                <div className="xl:col-span-8 space-y-6">
                  {/* Quick Stats Grid */}
                  <StatsRow stats={DASHBOARD_STATS} />
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <RecentResults
                      ...
                      onSelectResult={() => setIsPerformanceModalOpen(true)}
                    />
                    <PerformanceOverview
                ...
                <div className="xl:col-span-4 h-full">
                  <AchievementsCard
                    onViewAll={() => onSelectTab?.("certificates")}
                  />
                </div>
              </div>
            </>
