...
export default function HeroFeaturesGrid() {
  ...
  return (
    <section className="pb-16 bg-white w-full font-sans">
      <div className="w-full px-4 sm:px-6 lg:px-10 xl:px-12 max-w-[1920px] mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5">
          {features.map((item, idx) => (
            ...
            >
              <div>
                <div className="size-12 rounded-2xl bg-gradient-to-tr from-purple-700 to-fuchsia-600 flex items-center justify-center mb-5 shadow-md shadow-purple-600/20">
                  {item.icon}
                </div>
