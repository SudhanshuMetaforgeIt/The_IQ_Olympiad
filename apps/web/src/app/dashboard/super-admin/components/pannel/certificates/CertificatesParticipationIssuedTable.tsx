...
interface CertificatesParticipationIssuedTableProps {
...
export default function CertificatesParticipationIssuedTable({
  data,
  onViewCertificate,
  onDownloadCertificate,
}: CertificatesParticipationIssuedTableProps) {
    ...
    <div className="bg-white rounded-2xl border border-slate-200/80 shadow-2xs overflow-hidden flex flex-col w-full">
      ...
      <div className="p-5 border-b border-slate-100">
        <h3 className="text-lg font-bold text-slate-900 tracking-tight">
          Participation Certificates Issued (12,845)
        </h3>
        <p className="text-xs font-semibold text-slate-400 mt-0.5">
          Showing students who have been issued participation certificates.
        </p>
      </div>
      ...
      <div className="p-4 border-t border-slate-100 bg-white flex flex-col sm:flex-row items-center justify-between gap-3 text-xs font-semibold text-slate-400">
        <div>Showing 1 to 10 of 12,845 participation certificates issued</div>
