...
export function MeritAppearedTrendChart() {
  return (
    <div className="bg-white rounded-3xl p-5 border border-slate-200/80 shadow-sm flex flex-col justify-between">
      ...
      <div className="relative w-full h-48">
        <svg viewBox="0 0 400 160" className="w-full h-full overflow-visible">
          ...
          <defs>
            <linearGradient id="purpleGradientMerit" x1="0" y1="0" x2="0" y2="1">
          ...
          <path
            d="M 50 120 L 110 110 L 170 98 L 230 85 L 290 70 L 350 48 L 350 140 L 50 140 Z"
            fill="url(#purpleGradientMerit)"
          />

          {/* Purple Line */}
          <path
            d="M 50 120 L 110 110 L 170 98 L 230 85 L 290 70 L 350 48"
            fill="none"
            stroke="#6B46C1"
            strokeWidth="3"
            strokeLinecap="round"
          ...
          {/* Value Labels & Circles */}
          {/* Point 1: 620 */}
          <circle cx="50" cy="120" r="4.5" fill="#FFFFFF" stroke="#6B46C1" strokeWidth="2.5" />
          <text x="50" y="110" textAnchor="middle" className="text-[10px] fill-slate-900 font-bold">620</text>
          ...
          {/* Point 3: 910 */}
          <circle cx="170" cy="98" r="4.5" fill="#FFFFFF" stroke="#6B46C1" strokeWidth="2.5" />
          <text x="170" y="88" textAnchor="middle" className="text-[10px] fill-slate-900 font-bold">910</text>
          ...
          {/* Point 5: 1,230 */}
          <circle cx="290" cy="70" r="4.5" fill="#FFFFFF" stroke="#6B46C1" strokeWidth="2.5" />
          <text x="290" y="60" textAnchor="middle" className="text-[10px] fill-slate-900 font-bold">1,230</text>

          {/* Point 6: 1,624 */}
          <circle cx="350" cy="48" r="5" fill="#6B46C1" stroke="#FFFFFF" strokeWidth="2" />
          <text x="350" y="38" textAnchor="middle" className="text-[10px] fill-purple-700 font-extrabold">1,624</text>
        </svg>
      </div>
