    ...
    <div className="flex h-screen overflow-hidden bg-[#F8FAFC] font-sans antialiased text-slate-900">
      ...
      <div className="flex-1 flex flex-col h-screen overflow-y-auto min-w-0">
        ...
        <main className="flex-1 p-4 md:p-8 space-y-6">
          {/* Toast Notification */}
          {toastMessage && (
            <div className="fixed bottom-6 right-6 z-50 bg-slate-900 text-white px-5 py-3.5 rounded-2xl shadow-2xl border border-slate-700 text-xs sm:text-sm font-bold flex items-center gap-3 animate-fade-in">
          ...
          <div className="bg-white rounded-3xl border border-slate-200/80 shadow-sm p-6 sm:p-8 space-y-6">
            ...
            {filteredExams.length > 0 ? (
              ...
              /* Empty State for Registered tab when no exams registered */
              <div className="py-14 text-center space-y-3">
                <div className="size-16 rounded-3xl bg-violet-50 text-violet-600 flex items-center justify-center mx-auto text-2xl border border-violet-100">
                  📝
                </div>
                ...
                <button
                  ...
                  className="px-5 py-2.5 rounded-xl bg-violet-600 text-white font-bold text-xs hover:bg-violet-700 transition cursor-pointer shadow-xs"
                >
