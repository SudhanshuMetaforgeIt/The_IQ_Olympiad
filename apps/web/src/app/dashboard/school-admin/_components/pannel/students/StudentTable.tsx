              ...
              <tr key={student.id} className="hover:bg-slate-50/80 transition-colors">
                <td className="py-4 px-6">
                  <div className="flex items-center space-x-3.5">
                    ...
                    />
                    <span className="font-bold text-slate-900 text-body">{student.name}</span>
                  </div>
                </td>
                <td className="py-4 px-4 font-bold text-slate-900 text-table">{student.admissionNo}</td>
                <td className="py-4 px-4 font-bold text-slate-900 text-table tabular-nums">{student.rollNumber}</td>
                <td className="py-4 px-4 text-slate-600 text-table">{student.className}</td>
                <td className="py-4 px-4 text-slate-600 text-table">{student.section}</td>
                <td className="py-4 px-4 font-bold text-slate-900 text-table tabular-nums">{student.phone}</td>
                <td className="py-4 px-4 text-slate-500 text-table">{student.email}</td>
                ...
                <td className="py-4 px-6 text-right">
                  <div className="flex items-center justify-end space-x-2">
                    <button className="p-1.5 text-purple-600 hover:text-purple-900 hover:bg-purple-50 rounded-lg transition-colors" title="Edit Student">
                      <Edit2 className="w-4 h-4" />
                    </button>
                    <button className="p-1.5 text-slate-400 hover:text-slate-600 hover:bg-slate-100 rounded-lg transition-colors" title="Delete Student">
